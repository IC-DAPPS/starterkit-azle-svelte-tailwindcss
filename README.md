# starterkit-azle-svelte-tailwindcss

Welcome to your new starterkit-azle-svelte-tailwindcss project and to the Internet Computer development community. By default, creating a new project adds this README and some template files to your project directory. You can edit these template files to customize your project and to include your own code to speed up the development cycle.
...
```bash
cd starterkit-azle-svelte-tailwindcss/
dfx help
dfx canister --help
```
